...
@Component({
    standalone: true,
    templateUrl: './house-rent-back-billing.component.html',
...
export class HouseRentBackBillingComponent implements OnInit {
                ...
                this.rentBillingService.applyBackRentalBill(this.currentUser, this.rentalBillFormGroup.value)
                    .subscribe({
                        next: (res: GeneralResponse): void => {
                            ...
                            this.rentalBillFormGroup.patchValue(
                                {
                                    billingType: 'PROP',
                                    startMonth: this.utilsService.getLastMonthName(),
                                    startYear: this.utilsService.getLastDayOfPreviousMonth().getFullYear(),
                                    endMonth: this.utilsService.getCurrentMonthName(),
    ...
    /**
     * Fetches the list of blocks for the selected estate from the API
     * and updates the listOfBlocks property with the results.
     *
     * Calls the settingsService to get the blocks for the estate.
     * Handles success and error cases.
     * Logs and shows errors or success messages as needed.
     */
    fetchBlocks(): void {
        this.listOfBlocks = [];
        this.settingsService
            .getEstateBlocks(this.currentUser, this.rentalBillForm.estateId.value)
            .subscribe({
     ...
     * @param ui - The UI element related to the action
     */
