...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: HttpCacheManager, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: RequestsQueue }, { type: HttpCacheStorage }, { type: HttpCacheGuard }, { type: TTLManager }, { type: RequestsCache }, { type: HttpCacheVersions }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [HTTP_CACHE_CONFIG]
                }] }]; } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: HttpCacheInterceptor, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: HttpCacheManager }, { type: KeySerializer }, { type: Object, decorators: [{
                    type: Inject,
                    args: [PLATFORM_ID]
...
function requestDataChanged(previousRequest, currentRequest) {
    return (previousRequest?.urlWithParams !== currentRequest.urlWithParams ||
